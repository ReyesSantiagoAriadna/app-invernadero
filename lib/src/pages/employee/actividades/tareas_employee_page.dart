...
import 'package:app_invernadero_trabajador/src/pages/employee/actividades/tarea_employee_widget.dart';
...
class TareasEmployeePage extends StatefulWidget {
  TareasEmployeePage({Key key}) : super(key: key);

  @override
  _TareasEmployeePageState createState() => _TareasEmployeePageState();
}


class _TareasEmployeePageState extends State<TareasEmployeePage> {
  PageBloc _pageBloc;
                ...
                builder: (BuildContext context, AsyncSnapshot snapshot){
                  if(snapshot.hasData){
                    ...
                    return ListView.builder(
                      ...
                      return TareaEmployeeWidget(tarea:tareas[index],tareaBloc: tareaBloc,);
                     },
                    );
                  }
                  return Container(
