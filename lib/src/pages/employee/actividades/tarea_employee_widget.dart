...
class TareaEmployeeWidget extends StatefulWidget {
  final Tarea tarea;
  final ActividadTareaBloc tareaBloc;

  const TareaEmployeeWidget({Key key, this.tarea, this.tareaBloc}) : super(key: key);

 
  @override
  _TareaEmployeeWidgetState createState() => _TareaEmployeeWidgetState();
}

class _TareaEmployeeWidgetState extends State<TareaEmployeeWidget> {
