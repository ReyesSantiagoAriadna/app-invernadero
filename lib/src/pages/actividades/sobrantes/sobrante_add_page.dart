...
class SobranteAddPage extends StatefulWidget {
  SobranteAddPage({Key key}) : super(key: key);

  @override
  _SobranteAddPageState createState() => _SobranteAddPageState();
}

class _SobranteAddPageState extends State<SobranteAddPage> {
      ...
      children: <Widget>[
        Positioned(
          ...
          appBar: AppBar(
            ...
            backgroundColor: Colors.white,
            title:Text("Nuevo Sobrante",style:TextStyle(color: MyColors.GreyIcon,
  ...
  _createButton(){
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot){
          ...
          onPressed: snapshot.hasData?()=>_addSobrante():null
          );
      },
    );
  }
  ...
  _addSobrante()async{
    ...
    await sobranteBloc.addSobrante(context);
