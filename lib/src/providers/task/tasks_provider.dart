...
class TaskProvider{
  static final TaskProvider _TaskProvider = TaskProvider._internal();
  ...
  Future<Map<DateTime, List<TareasPersonal>>> loadTareasPersonal(int cultivo)async{  
    ...
    if(response.body.contains("tareas_personal") && response.body.contains("id_tarea")){
      TareasDate tareasDate = TareasDate.fromJson(json.decode(response.body)); 
      _loading=false;
      return tareasDate.tareasPersonal;
    }
    _loading=false;
    return null;
  } 
